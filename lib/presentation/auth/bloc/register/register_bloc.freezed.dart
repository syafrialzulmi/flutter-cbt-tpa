...
class _$RegisterImpl with DiagnosticableTreeMixin implements _Register {
  const _$RegisterImpl(this.registerRequestModel);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('registerRequestModel', registerRequestModel));
  }
...
abstract class _Register implements RegisterEvent {
  const factory _Register(final RegisterRequestModel registerRequestModel) =
      _$RegisterImpl;
...
class _$SuccessImpl with DiagnosticableTreeMixin implements _Success {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('authResponseModel', authResponseModel));
  }
